    ...
    return (
        <div className="min-h-screen lg:w-2/3 mx-auto pt-24 text-center lg:text-start px-2 ">
            ...
            <div class="flex justify-center gap-4 mt-6 lg:justify-start">
                ...
                <a target="_blank" class="text-lg text-white rounded btn bg-pink-800 hover:bg-transparent hover:border-accent-400 hover:transition-all hover:duration-1000 hover:text-white" href="https://drive.google.com/file/d/1EznHKJgX8JfLqxbWVvr-kUokJqBrlnx3/view?usp=sharing">Resume</a>
            </div>
            <div className="mt-5">

...
const ClientLogosMarquee = () => {
  return (
    <section className="py-10 mb-10 rounded-xl  bg-gray-100">
      <div className="max-w-7xl mx-auto px-4">
        <h2 className="text-2xl bg-gradient-to-r from-blue-600 to-purple-800 md:w-80 rounded-lg py-2 mx-auto font-bold text-center mb-12">Trusted by Leading Brands</h2>
